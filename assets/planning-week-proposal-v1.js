...
(()=>{
const VERSION='20260925-9',clone=x=>JSON.parse(JSON.stringify(x));
...
function discardSilently(){proposal=null;try{renderWeeks()}catch(_){}return true}
